...
# Calculate raw velocities (numerical derivative of altitude)
raw_velocities = np.gradient(measurements, time_steps)
...
# Plot velocity
plt.subplot(2, 1, 2)
plt.plot(time_steps, raw_velocities, label='Raw Velocity (Numerical Derivative)', color='red', linestyle='dashed')
